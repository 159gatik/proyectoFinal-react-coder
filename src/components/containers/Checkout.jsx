            ...
            <div className='container'>
                <form onSubmit={consultarFormulario} ref={formularioReferenciado}>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" name="nombre" placeholder="Ingresa tu domicilio" />
                    </div>

                    <button type="submit" className="btn btn-primary">Atras</button>

                    <Link to="/"> <button type="submit" onClick={() => compraRealizada()} className="btn btn-success" to="/">finalizar compra</button> </Link>
                </form>
            </div>
        </>
    );
