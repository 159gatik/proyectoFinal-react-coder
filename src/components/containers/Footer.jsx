                ...
                <div className='footer'>
                    <div className='d-flex justify-content-center'>
                        <ul className='row mt-5 text-center'>
                            <h4>Contactános</h4>
                            <li><i className="fa-brands fa-whatsapp"></i> 2454521</li>
                        ...
                        <ul className='mt-5 text-center'>
                            ...
                            <li><i className="fa-brands fa-instagram"> pinto.bike</i></li>
                            <li><i className="fa-brands fa-facebook-f"> pinto bike</i></li>
                        </ul>
                    </div>
                </div>
            </footer>
